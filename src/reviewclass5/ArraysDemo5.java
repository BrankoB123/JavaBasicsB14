...
public class ArraysDemo5 {
	...
	public static void main(String[] args) {
        ...
        //limitations enhanced for loop
        //we can go only one direction
        //we can't skip the elements
        //we can't use enhanced for loop to update elements in an array (no scanner)
        //we can only use it to access the elements
        //no indexes in this loop
        double sum=0;
